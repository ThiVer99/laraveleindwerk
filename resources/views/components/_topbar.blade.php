                ...
                <div class="d-flex" style="background:#f8f9fc;">
                    @foreach($fillableFields as $field)
                        <div class="form-check mr-2">
                            <input class="form-check-input" type="checkbox" value="{{ $field }}" id="{{ $field }}" name="fields[]" {{ in_array($field, (array)Request::get('fields', [])) ? 'checked' : '' }}>
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{asset('imag/undraw_profile_1.svg')}}"
                             alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{asset('imag/undraw_profile_2.svg')}}"
                             alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{asset('imag/undraw_profile_3.svg')}}"
                             alt="...">
